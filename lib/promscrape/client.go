...
func (c *client) ReadData(dst *bytesutil.ByteBuffer) error {
	...
	// See https://github.com/zzylol/VictoriaMetrics-sketches/issues/608 for details.
	...
	// See https://github.com/zzylol/VictoriaMetrics-sketches/issues/1179#issuecomment-813117162
