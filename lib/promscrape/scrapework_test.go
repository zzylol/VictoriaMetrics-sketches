...
func TestScrapeWorkScrapeInternalSuccess(t *testing.T) {
	...
	`)
	// Empty instance override. See https://github.com/zzylol/VictoriaMetrics-sketches/issues/453
	f(`
...
`),
	...
	// See https://github.com/zzylol/VictoriaMetrics-sketches/issues/3406
	f(`
		up{bar="baz"} 34.44
		bar{a="b",c="d"} -3e4
