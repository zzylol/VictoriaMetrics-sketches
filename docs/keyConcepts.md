...
in the [example docker-compose manifest](https://github.com/zzylol/VictoriaMetrics-sketches/tree/master/deployment/docker).
In this example vmagent [scrapes a list of targets](https://github.com/zzylol/VictoriaMetrics-sketches/blob/master/deployment/docker/prometheus.yml)
and [forwards collected data to VictoriaMetrics](https://github.com/zzylol/VictoriaMetrics-sketches/blob/9d7da130b5a873be334b38c8d8dec702c9e8fac5/deployment/docker/docker-compose.yml#L15).
VictoriaMetrics is then used as a [datasource for Grafana](https://github.com/zzylol/VictoriaMetrics-sketches/tree/master/deployment/docker/provisioning/datasources)
