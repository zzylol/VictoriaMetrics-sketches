...
- [Docker-compose demo for Fluentbit integration with VictoriaLogs](https://github.com/zzylol/VictoriaMetrics-sketches/tree/master/deployment/docker/victorialogs/fluentbit-docker).
